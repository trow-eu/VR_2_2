...
public class IKControlSpider : MonoBehaviour
{
        ...
        if (animator)
        {
            ...
            if (ikActive)
            {
                if (leftHandObj != null)
                {
                    ...
                    animator.SetIKPosition(AvatarIKGoal.LeftHand, leftHandObj.position + new Vector3(0, -0.5f, 0)) ;
                ...
                if (rightHandObj != null)
                {
                    ...
                    animator.SetIKPosition(AvatarIKGoal.RightHand, rightHandObj.position + new Vector3(0, -0.5f, 0));
